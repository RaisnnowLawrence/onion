...
class OfficialVQAAnswerProcessor:
    """VQA official answer normalization used before direct-answer matching."""
    ...
    def process_punctuation(self, text):
        ...
        for punct in self.punct:
            if (punct + " " in in_text or " " + punct in in_text) or (
...
_PROCESSOR = OfficialVQAAnswerProcessor()
