...
ENGINE=qwen3-VL-4B
EXP_NAME=mcts_image_no_cot_rounds1_4shards
...
LOG_DIR="${REPORT_DIR}/logs_mcts_round1_4shards"
MASTER_LOG="${REPORT_DIR}/mcts_round1_4shards_master.log"

CACHE_PATH=/data2/lizhengxue/WorkSpace/huchunning/VisualCoT-data/image_cache_onion/cache_forward4b_mcts_round1_4shards
