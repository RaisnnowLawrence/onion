...
RUN_BATCH_ID="${RUN_BATCH_ID:-gqa_testdev_dyfo_free_key_weighted_vote_gpu2345_2000_$(date +%Y%m%d_%H%M%S)}"
TS_SOCKET="${TS_SOCKET:-/tmp/ts_onion_${RUN_BATCH_ID}.sock}"
RUN_ID="${RUN_ID:-gqa_testdev_dyfo_free_key_weighted_vote_8shards_2000_${RUN_BATCH_ID}}"
