...
OUT_ROOT="/data2/lizhengxue/WorkSpace/onion_output/pope/dyfo_decision_all/${RUN_ID}"
LOGDIR="/data2/lizhengxue/WorkSpace/onion_output/ablation_summary/logs_pope_dyfo_decision_all/${RUN_ID}"
...
BASE_ARGS=(
  ...
  --coco_path "${POPE_ROOT}"
  --aokvqa_context_path "${AOKVQA_ROOT}"
