...
MASTER_LOG="${REPORT_DIR}/mcts_safe_round1_n5_4shards_master.log"

CACHE_PATH=/data2/lizhengxue/WorkSpace/huchunning/VisualCoT-data/image_cache_onion/cache_forward4b_mcts_safe_round1_n5_4shards
