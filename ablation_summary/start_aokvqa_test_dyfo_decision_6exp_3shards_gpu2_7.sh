...
RUN_ID="${1:-aokvqa_test_dyfo_decision_6exp_$(date +%Y%m%d_%H%M%S)}"
...
AOKVQA_TEST_ANNO="/data2/lizhengxue/WorkSpace/onion_output/aokvqa/test_official_scored_annotations"
COCO17_ROOT="/data2/lizhengxue/datasets/coco17"
COCO17_ANNO="/data2/lizhengxue/datasets/coco17/annotations"
OUT_ROOT="/data2/lizhengxue/WorkSpace/onion_output/aokvqa/dyfo_decision_test/${RUN_ID}"
LOGDIR="/data2/lizhengxue/WorkSpace/onion_output/ablation_summary/logs_aokvqa_dyfo_decision_test/${RUN_ID}"
...
BASE_ARGS=(
  ...
  --split_name test
  --engine "${ENGINE}"
  --raw_image_dir "${COCO17_ROOT}"
  --coco_path "${AOKVQA_TEST_ANNO}"
