...
ENGINE=qwen3-VL-4B
EXP_NAME=mcts_narrow_no_cot_rounds1_n10_6shards
...
LOG_DIR="${REPORT_DIR}/logs_mcts_narrow_round1_n10_6shards"
MASTER_LOG="${REPORT_DIR}/mcts_narrow_round1_n10_6shards_master.log"

CACHE_PATH=/data2/lizhengxue/WorkSpace/huchunning/VisualCoT-data/image_cache_onion/cache_forward4b_mcts_narrow_round1_n10_6shards
...
main() {
    echo "[$(timestamp)] MCTS narrow round1 6-shard experiment started" | tee -a "${MASTER_LOG}"
    ...
    echo "[$(timestamp)] MCTS narrow round1 6-shard experiment finished with $(sample_count)/1145 samples" | tee -a "${MASTER_LOG}"
}
