...
RUN_ID="${1:-okvqa_dyfo_decision_6exp_$(date +%Y%m%d_%H%M%S)}"
...
OUT_ROOT="/data2/lizhengxue/WorkSpace/onion_output/okvqa/dyfo_decision_val/${RUN_ID}"
LOGDIR="/data2/lizhengxue/WorkSpace/onion_output/ablation_summary/logs_okvqa_dyfo_decision_val/${RUN_ID}"
